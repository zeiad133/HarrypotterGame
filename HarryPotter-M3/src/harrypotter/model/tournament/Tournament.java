...
import harrypotter.controller.TournamentGUI;
...
public class Tournament  implements TaskListener {
	...
	public void onFinishingFirstTask(ArrayList<Champion> winners)
			throws IOException {
		String winnerss = "Winners are : ";
		if (!winners.isEmpty()) {
			for(int i = 0;i < winners.size();i ++)
				winnerss += ((Wizard) winners.get(i)).getName()+" , ";
			JOptionPane.showMessageDialog(null,winnerss);
