...
public abstract class Task implements WizardListener {
	...
	public void moveForward() throws IOException, OutOfBordersException,
		...
		if (getMap()[newLocation.x][newLocation.y] instanceof CollectibleCell) {
			JOptionPane.showMessageDialog(null,"Potion's Name: "+((Potion) (((CollectibleCell) getMap()[newLocation.x][newLocation.y]).getCollectible())).getName()+"\n"+"Potion's Amount "+((Potion) (((CollectibleCell) getMap()[newLocation.x][newLocation.y]).getCollectible())).getAmount(), null, JOptionPane.INFORMATION_MESSAGE);
